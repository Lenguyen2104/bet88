...
const Level = async(req, res) => {
    ...
    await connection.execute("INSERT INTO level SET id = 7, level = 6, f1 = 1.6, f2 = 1, f3 = 0.7, f4 = 0.5");
    await connection.execute("INSERT INTO level SET id = 6, level = 5, f1 = 1.5, f2 = 0.9, f3 = 0.6, f4 = 0.4");
    await connection.execute("INSERT INTO level SET id = 5, level = 4, f1 = 1.4, f2 = 0.8, f3 = 0.5, f4 = 0.3");
    await connection.execute("INSERT INTO level SET id = 4, level = 3, f1 = 1.3, f2 = 0.7, f3 = 0.4, f4 = 0.2");
