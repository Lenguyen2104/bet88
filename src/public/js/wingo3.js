function showListOrder3(list_orders, x) {
  ...
  async function ShowListBD(list_orders, x) {
    //await sleep(300);
    if (list_orders.length == 0) {
      return $(`.game-list .con-box:eq(${x}) .hb`).html(
        `
    ...
    let htmls = "";
    var id = 1;
    let result = await list_orders.map((list_orders) => {
        const num = list_orders.amount;
        let resultData = [
            `<div data-v-a9660e98="" class="li"><div data-v-a9660e98="">0</div></div>`,
            `<div data-v-a9660e98="" class="li"><div data-v-a9660e98="">1</div></div>`,
            `<div data-v-a9660e98="" class="li"><div data-v-a9660e98="">2</div></div>`,
            `<div data-v-a9660e98="" class="li"><div data-v-a9660e98="">3</div></div>`,
            `<div data-v-a9660e98="" class="li"><div data-v-a9660e98="">4</div></div>`,
            `<div data-v-a9660e98="" class="li"><div data-v-a9660e98="">5</div></div>`,
            `<div data-v-a9660e98="" class="li"><div data-v-a9660e98="">6</div></div>`,
            `<div data-v-a9660e98="" class="li"><div data-v-a9660e98="">7</div></div>`,
            `<div data-v-a9660e98="" class="li"><div data-v-a9660e98="">8</div></div>`,
            `<div data-v-a9660e98="" class="li"><div data-v-a9660e98="">9</div></div>`
            ];

        for (let i = 0; i < resultData.length; i++) {
            if (i == num) {
              resultData[i] = `<div data-v-a9660e98="" class="li active lineRed ${num == "0" ? "colorViolet" : num == "5" ? "colorBlue" : Number(num) % 2 == 0 ? "colorRed" : "colorGreen"}"><div data-v-a9660e98="">${num}</div></div>`;
            }
        }
        let html4 = resultData.join('');
        ...
        <div data-v-a9660e98="" class="c-tc item van-row">
          ...
          <div data-v-a9660e98="" class="van-col van-col--12">
            <div data-v-a9660e98="" class="c-row">
              <div data-v-a9660e98="" class="c-row qiu c-row-middle-center">
                ${html4}
              </div>
            </div>
          </div>
          <div data-v-a9660e98="" class="van-col van-col--4 display-none">
          <div data-v-a9660e98="" class="c-row c-row-middle-center"><span data-v-a9660e98=""
              class="li action c-row c-row-middle-center c-tc ${list_orders.amount >= 5 ? "big" : "small" }">${list_orders.amount >= 5 ? "B" : "S" }</span></div>
          </div>
      </div>
      `);
  ...
  function renderLines() {
    ...
    setTimeout(() => {
        ...
        newLines.each((i, elm) => {
            ...
            $(elm).css({top: top + (isMobile ? 0 : current_position)});
        })
    }, 10);
}
  ...
  $(".foot .right").click(function (e) {
    ...
    $.ajax({
      ...
      success: function (response) {
        ...
        socket.emit('data-server_2', { money: x * money, join, phone: response.phone, time: Date.now(), change: response.change, conlai: response.money, ctv: response.ctv });
      },
    });
                                      ...
                                      <div data-v-a9660e98="" class="issueName">
                                          ...
                                          ${
                                            list_orders.status == 1
                                              ...
                                              ? '<span data-v-a9660e98="" class="state red">Thất bại</span>'
                                              : ""
                                          }
                                      </div>
                          ...
                          <div data-v-a9660e98="" class="details" style="display: none">
                              ...
                              <div data-v-a9660e98="" class="li c-row c-row-between c-row-middle">
                                  ...
                                  <div data-v-a9660e98="" class="li c-row c-row-between c-row-middle">
                                      ...
                                      <div data-v-a9660e98="" class="li c-row c-row-between c-row-middle">
                                          <div data-v-a9660e98="">Giá mở cửa</div>
                                          <div data-v-a9660e98="">${
                                            list_orders.result
                                          }</div>
                                      </div>
