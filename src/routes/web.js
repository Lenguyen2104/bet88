...
const initWebRouter = (app) => {
    ...
    router.get('/home/all', homeController.gamePage);
    router.get('/getNotice', homeController.getNotice);
    ...
    router.get('/wallet/editBank', middlewareController, homeController.editBank);
    ...
    router.post('/api/webapi/editBank', middlewareController, userController.editBank); // register
    ...
    router.post('/admin/manager/updateBank',adminController.middlewareAdminController,adminController.updateBank)
    ...
    router.get('/daily/wingo', dailyController.middlewareDailyController, dailyController.dailyPageWingo); // get info account
    router.get('/daily/wingo/3', dailyController.middlewareDailyController, dailyController.dailyPageWingo3); // get info account
    router.get('/daily/wingo/5', dailyController.middlewareDailyController, dailyController.dailyPageWingo5); // get info account
    router.get('/daily/wingo/10', dailyController.middlewareDailyController, dailyController.dailyPageWingo10); // get info account

    router.get('/daily/k5', dailyController.middlewareDailyController, dailyController.dailyPageK5); // get info account
    router.get('/daily/k3', dailyController.middlewareDailyController, dailyController.dailyPageK3); // get info account
    ...
    router.post('/admin/manager/settings/doictv', adminController.middlewareAdminController, adminController.settingctv); // get info account
    router.post('/admin/manager/settings/doipass', adminController.middlewareAdminController, adminController.doipassU);
    ...
    router.post('/admin/member/listCapduoi/:phone', adminController.middlewareAdminController, adminController.listCapduoi);
    ...
    router.post('/admin/member/betk3/:phone', adminController.middlewareAdminController, adminController.listBetk3);
    router.post('/admin/member/betk5/:phone', adminController.middlewareAdminController, adminController.listBetk5);
    ...
    router.post('/api/webapi/admin/k3/editResult', adminController.middlewareAdminController, adminController.editResultK3); // edit ket qua k3
